...
def get_config():
    ...
    return ConfigDict(
        dict(
            ...
            resume_path="gs://multi-robot-bucket2/runs/octo/final/280000", # need to get checkpoint!!! upload it using gsutil. 
...
def get_dataset_config(task_cond, window_size, action_horizon):
    ...
    return dict(
        oxe_kwargs=dict(
            data_mix=[
                    ("aloha_sushi_cut_full_dataset", 1.0),
                    # ("aloha_dough_cut_dataset", 1.0),
            ],
